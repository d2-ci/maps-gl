...
exports.setVectorStyleOpacity = exports.clearVectorStyleOpacityCache = void 0;
...
const scaleZoomCurve = (expression, opacity) => {
  ...
  const scaleOutputs = stops => stops.map((value, i) => i % 2 === 1 ? value * opacity : value);
  if (type === 'interpolate') {
...
const scaleValue = (baseValue, opacity) => {
  ...
  if (Array.isArray(baseValue) && ['interpolate', 'step'].includes(baseValue[0])) {
...
const clearVectorStyleOpacityCache = mapgl => {
...
exports.setVectorStyleOpacity = setVectorStyleOpacity;