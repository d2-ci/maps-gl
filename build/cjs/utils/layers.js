...
exports.symbolLayer = exports.polygonLayer = exports.pointLayer = exports.outlineLayer = exports.lineLayer = exports.clusterLayer = exports.clusterCountLayer = exports.OVERLAY_START_POSITION = exports.MAP_MAX_ZOOM = exports.BASEMAP_POSITION = void 0;
...
const MAP_MAX_ZOOM = exports.MAP_MAX_ZOOM = 18;
...
const pointLayer = ({
  ...
  paint: {
    ...
    'circle-stroke-color': (0, _expressions.highlightColorExpr)(strokeColor || _style.circleStrokeColor),
...
const lineLayer = ({
  ...
  source: source || id,
  paint: {
    'line-color': (0, _expressions.highlightColorExpr)(color || _style.lineStrokeColor),
...
const clusterLayer = ({
  ...
  paint: {
    ...
    'circle-opacity': opacity ?? _style.circleOpacity,
    'circle-stroke-color': (0, _expressions.highlightColorExpr)(strokeColor),
