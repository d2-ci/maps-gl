...
export const getZoomResolution = zoom => 2 * Math.PI * earthRadius / 256 / Math.pow(2, zoom);
...
export const bboxIntersect = (bbox1, bbox2) => !(bbox1[0] > bbox2[2] || bbox1[2] < bbox2[0] || bbox1[3] < bbox2[1] || bbox1[1] > bbox2[3]);