...
import { DEFAULT_SCALE, filterCollectionByDateRange, getAdjustedScale, combineReducers, getScale, getClassifiedImage, applyFilter, applyMethods, applyCloudMask, aggregateTemporal, aggregateTemporalWeighted, selectBand, getAggregatorFn } from '../ee_worker_utils.js';
describe('EE-dependent functions (mocked)', () => {
  ...
  test('getClassifiedImage (array style) calls remap with correct structure', () => {
    ...
    const result = getClassifiedImage(image, {
      style,
      band: 'B1'
    });
